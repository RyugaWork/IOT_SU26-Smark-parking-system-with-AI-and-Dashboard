                        ...
                        <div class="image-box">
                            ...
                            <c:choose>
                                <c:when test="${not empty latestEntry.annotatedImagePath}">
                                    <img src="${pageContext.request.contextPath}/parking-image/${latestEntry.annotatedImagePath}"
                                         alt="Latest entry image">
                                </c:when>

                                <c:when test="${not empty latestEntry.rawImagePath}">
                                    <img src="${pageContext.request.contextPath}/parking-image/${latestEntry.rawImagePath}"
                                         alt="Latest entry image">
                                </c:when>
                        ...
                        <div class="image-box">
                            ...
                            <c:choose>
                                <c:when test="${not empty latestExit.annotatedImagePath}">
                                    <img src="${pageContext.request.contextPath}/parking-image/${latestExit.annotatedImagePath}"
                                         alt="Latest exit image">
                                </c:when>

                                <c:when test="${not empty latestExit.rawImagePath}">
                                    <img src="${pageContext.request.contextPath}/parking-image/${latestExit.rawImagePath}"
                                         alt="Latest exit image">
                                </c:when>
